    ...
    var Home = Backbone.View.extend({
        ...
        initData: function () {
            ...
            table = $('#table').DataTable({
                "ajax": {
                    url: baseUrl + "/unpaid/getunpaidrecord"
                },
                "columns": [
                    {"data": "payTarget"},
                    {"data": "payTypeDes"},
                    ...
                    {"data": "payDeadline"},
                    {
                        render: function (data, type, row, meta) {
                            var str = "";
                            str += "<button data-id='" + row.id + "' class='btn-primary btn del-btn btn-xs refresh-btn '> 操作</button>";
...
//            resourceId = target.data("id");
            $(".alert-view .alert-txt", parent.document).text("操作");
